...
salidaCAM=open("CAM","w")
salidaCDM=open("CDM","w")
salidaCTM=open("CTM","w")
salidaDM=open("DM","w")
salidaDT=open("DT","w")
salidaTM=open("TM","w")
salidaTT=open("TT","w")
