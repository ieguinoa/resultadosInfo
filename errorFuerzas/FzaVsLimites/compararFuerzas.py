...
fuerzas1= []
fuerzas2=[]
for lines1 in input1:
    fuerzas1.append(float(lines1.split()[0]))
    
for lines2 in input2:
    fuerzas2.append(float(lines2.split()[0]))
    
    
maxDiferencia=0.0
dif=0.0
for x in range(len(fuerzas1)):
  dif=abs(fuerzas1[x]-fuerzas2[x])
